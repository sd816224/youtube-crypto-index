...
def search_videos(pages_to_search,google_api_key,q,order,search_type,page_token=None):
   ...
   """
    ...
    payload=fetch_videos_page(google_api_key,q,order,search_type,page_token)
...
def fetch_videos_page(google_api_key,playlistId,order,search_type,page_token=None):
